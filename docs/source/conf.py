...
latex_documents = [
    (master_doc, 'py-galactic.tex', 'py-galactic Documentation',
     'The Galactic Organization', 'manual'),
]
...
man_pages = [
    (master_doc, 'py-galactic', 'py-galactic Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'py-galactic', 'py-galactic Documentation',
     author, 'py-galactic', 'One line description of project.',
     'Miscellaneous'),
]
